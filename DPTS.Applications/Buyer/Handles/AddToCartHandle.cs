...
public class AddToCartHandle : IRequestHandler<AddToCartQuery, ServiceResult<string>>
{
    ...
    private readonly ILogger<AddToCartHandle> _logger;

    public AddToCartHandle(
        ...
        ILogger<AddToCartHandle> logger)
    {
