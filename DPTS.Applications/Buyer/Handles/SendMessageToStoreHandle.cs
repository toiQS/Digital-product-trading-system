...
public class SendMessageToStoreHandle : IRequestHandler<SendMessageToStoreQuery, ServiceResult<ChatIndexListDto>>
{
    private readonly IMessageRepository _messageRepository;
    private readonly IUserProfileRepository _userProfileRepository;
    private readonly IStoreRepository _storeRepository;
    private readonly ILogRepository _logRepository;
    private readonly ILogger<SendMessageToStoreHandle> _logger;

    public SendMessageToStoreHandle(
        IMessageRepository messageRepository,
        IUserProfileRepository userProfileRepository,
        IStoreRepository storeRepository,
        ILogRepository logRepository,
        ILogger<SendMessageToStoreHandle> logger)
    {
