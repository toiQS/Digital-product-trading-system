...
namespace DPTS.Infrastructures.Repository.Interfaces
{
    public interface IProductReviewRepository
    {
        ...
        Task<IEnumerable<ProductReview>> GetsAsync(string? search = null, string? productId = null, string? userId = null, int? minRating = null, int? maxRating = null, DateTime? from = null, DateTime? to = null, bool includeUser = false, bool includeProduct = false);
